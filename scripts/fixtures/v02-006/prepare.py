...
assert root == Path('C:/tmp/v006/source').resolve()
control=root/'v006-provider'; control.mkdir(exist_ok=True)
...
for case in ['formula-outline','figures-captions','superscript-text']:
    ...
    lines=['V02-006 SYNTHETIC DEMO / parser and translations are fixtures','']
