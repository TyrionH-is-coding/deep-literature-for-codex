...
root=Path(sys.argv[1]);assert (root/'.v02-003c-test-instance').read_text()=='synthetic-only'
data=root/'library';state=json.loads((root/'v3c-conflict.json').read_text());pid=state['paper_id']
