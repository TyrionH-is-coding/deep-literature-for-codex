...
const out=path.join(root,'docs/project/evidence/V02-003D');fs.mkdirSync(out,{recursive:true});
const commands={check:['scripts/modules.mjs','check'],test:['scripts/modules.mjs','test','engine'],impact:['scripts/modules.mjs','impact','--base','c7757c49d509bcec28464120a82cd87d7360458f'],package:['scripts/package-release.mjs',path.join(root,'outputs/v02-003d-candidate'),path.join(root,'inputs/scientific-reading.tgz')]};
