...
assert.equal(installed.pins.plugin.sha256, 'fdce0ada390e2f27615c6b6050dbf7ef83c871d6a6304c4235e4414f667c8930');
...
const probe = async mode => JSON.parse(await run(installed.python,['-I','-X','utf8',path.join(here,'fixtures','v02-003c','engine-probe.py'),root,mode]));
