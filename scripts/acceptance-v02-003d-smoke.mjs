...
assert.equal(installed.pins.plugin.sha256, '2e1ec6ebbc9ca37d33060d978f5d1f855455bb4423cc5b481957b3da0259bc09');
...
const probe = async mode => JSON.parse(await run(installed.python,['-I','-X','utf8',path.join(here,'fixtures','v02-003d','engine-probe.py'),root,mode]));
