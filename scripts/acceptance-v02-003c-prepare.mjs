...
const cwd=process.cwd(), p=JSON.parse(await fs.readFile('docs/project/evidence/V02-003C/package.txt','utf8'));
const root='C:/Users/15694/AppData/Local/Temp/v3c';
...
await initializeRoot(root); await fs.writeFile(path.join(root,'.v02-003c-test-instance'),'synthetic-only');
...
await fs.writeFile('docs/project/evidence/V02-003C/cache-copy.json',JSON.stringify({root,extractedRoot:p.extractedRoot,records},null,2));
