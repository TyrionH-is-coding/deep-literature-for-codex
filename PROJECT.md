...
**004G诊断已通过并集成**到A `6d88f2b`，总控独立六场景重现直接服务状态不一致，正常CLI对照通过，见[004G复核](docs/project/evidence/V02-004G-control-review.md)。当前004F仍在实现与测试引擎停止控制；004H最小写前守卫需等F验收后串行派发，B工具接入另卡。004A-G1、004整体与005依赖仍未解除，不能把收到停止意图当成后台已停止。
